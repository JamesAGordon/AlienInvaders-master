...
//Above is the variable key codes that are used to play the game. The number refers to the javascript char codes. I found out the codes for up and down and added them in here to later be used to add to the movement of the player.
...
var Sprites = new function() {
  ...
  //this links to the sprite sheet. I edited the sprite sheet to change the characters in the game.
